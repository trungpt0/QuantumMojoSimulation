...
/usr/bin/python3 "$PROJECT_ROOT/benchmark/transpiler_stage1/opt_benchmark.py" "$PROJECT_ROOT/benchmark/transpiler_stage1/opt_benchmark.txt" --pass FullOptimize  
if [ $? -ne 0 ]; then
